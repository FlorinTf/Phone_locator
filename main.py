...
def add_info_to_db():
    ...
    db_connection_string = "mysql+pymysql://xtt21s7bt0zkkiuqqqqw:pscale_pw_VxZjpEoeNk2k7Op24myI3Yk0aYM20SGKRNZgXe1cafB@eu-central.connect.psdb.cloud/phone_locator?charset=utf8mb4"
